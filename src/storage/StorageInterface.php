...
interface StorageInterface
{
     ...
     *
     * Набор заменяет содержимое хранилища целиком: параметры, которых нет в $values, удаляются —
     * их значение вернулось к заданному в конфигурации модуля и хранить его больше незачем.
     *
